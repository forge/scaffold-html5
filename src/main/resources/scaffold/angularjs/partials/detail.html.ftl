<form id="new-${entityName}" name="new${entityName}" class="form-horizontal">
    ...
    <div class="control-group">
        <div class="controls">
            ...
            <button id="delete${entityName}" name="delete${entityName}" class="btn btn-danger" ng-show="${entityName?lower_case}.id" ng-click="remove()"><i class="icon-trash"></i> Delete</button>
        </div>
    <div>
</form>