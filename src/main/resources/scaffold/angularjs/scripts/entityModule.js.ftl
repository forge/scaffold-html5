...
angular.module('${entityName}',['ngResource']).
    ...
    .controller('Search${entityName}Controller', function($scope,$filter,$http,${entityName}Resource
<#list properties as property>
<#if (property["many-to-one"]!"false") == "true" || (property["one-to-one"]!"false") == "true">
,${property.simpleType}Resource
</#if>
    ...
    $scope.performSearch();
}).controller('New${entityName}Controller', function ($scope,$location,${entityName}Resource
<#list properties as property>
...
}).controller('Edit${entityName}Controller', function($scope,$routeParams,$location,${entityName}Resource
<#list properties as property>
<#if (property["many-to-one"]!"false") == "true" || (property["one-to-one"]!"false") == "true" || (property["n-to-many"]!"false") == "true">
, ${property.simpleType}Resource
</#if>
